...
var MinedMapLayer = L.GridLayer.extend({
	initialize: function (mipmaps, layer) {
		...
		this.options.attribution = 'Generated by <a href="https://github.com/Azerxim/MinedMap-Legacy">MinedMap Legacy</a>';
	...
	createTile: function (coords, done) {
		...
		*/
		...
		if (coords.x >= mipmap.bounds.minX && coords.x <= mipmap.bounds.maxX &&
			...
			tile.src = 'data/overworld/'+this.layer+'/'+z+'/r.'+coords.x+'.'+coords.y+'.png';
...
window.createMap = function () {
	...
	xhr.open('GET', 'data/overworld/info.json', true);
	xhr.send();
}
